...
if (module.hot) {
  (function () {
    ...
    if (!module.hot.data) {
      ...
      hotAPI.rerender("data-v-ce6e88f4", __vue__options__);
    }
  })();
}
...
__vue__options__.staticRenderFns = [function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('header', [_c('ul', [_c('li', [_vm._v("Home")]), _vm._v(" "), _c('li', [_vm._v("About")])])]);
}];
if (module.hot) {
    (function () {
        var hotAPI = require("vue-hot-reload-api");
        ...
        module.hot.accept();
        if (!module.hot.data) {
            hotAPI.createRecord("data-v-6b7f6114", __vue__options__);
        } else {
            hotAPI.reload("data-v-6b7f6114", __vue__options__);
        }
    })();
}
},{"vue-hot-reload-api":"node_modules\\vue-hot-reload-api\\dist\\index.js","vue":"node_modules\\vue\\dist\\vue.runtime.esm.js"}],"src\\Message.vue":[function(require,module,exports) {
;(function () {
    'use strict';
...
__vue__options__.render = function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', [_vm.hasMessage ? _c('span', { attrs: { "title": _vm.vue } }, [_vm._v(_vm._s(_vm.message))]) : _vm._e(), _vm._v(" "), _c('button', { on: { "click": _vm.logMessage } }, [_vm._v("Click Me!")]), _vm._v(" "), _c('button', { on: { "click": _vm.toggleMessage } }, [_vm._v("Toggle Message!")]), _vm._v(" "), _c('form', [_c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.message, expression: "message" }], attrs: { "type": "text" }, domProps: { "value": _vm.message }, on: { "input": function input($event) {
                if ($event.target.composing) {
                    return;
                }_vm.message = $event.target.value;
            } } }), _vm._v(" "), _c('input', { directives: [{ name: "model", rawName: "v-model", value: _vm.hasMessage, expression: "hasMessage" }], attrs: { "type": "checkbox" }, domProps: { "checked": Array.isArray(_vm.hasMessage) ? _vm._i(_vm.hasMessage, null) > -1 : _vm.hasMessage }, on: { "change": function change($event) {
                var $$a = _vm.hasMessage,
                    $$el = $event.target,
                    $$c = $$el.checked ? true : false;if (Array.isArray($$a)) {
                    var $$v = null,
                        $$i = _vm._i($$a, $$v);if ($$el.checked) {
                        $$i < 0 && (_vm.hasMessage = $$a.concat([$$v]));
                    } else {
                        $$i > -1 && (_vm.hasMessage = $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
                    }
                } else {
                    _vm.hasMessage = $$c;
                }
            } } })]), _vm._v(" "), _c('div', [_c('select', { directives: [{ name: "model", rawName: "v-model.lazy", value: _vm.selected, expression: "selected", modifiers: { "lazy": true } }], on: { "change": function change($event) {
                var $$selectedVal = Array.prototype.filter.call($event.target.options, function (o) {
                    return o.selected;
                }).map(function (o) {
                    var val = "_value" in o ? o._value : o.value;return val;
                });_vm.selected = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
            } } }, [_c('option', { attrs: { "disabled": "", "value": "" } }, [_vm._v("What's your favorite coffee?")]), _vm._v(" "), _c('option', [_vm._v("Cafe Latte")]), _vm._v(" "), _c('option', [_vm._v("Cappuchino")]), _vm._v(" "), _c('option', [_vm._v("Mocha Latte")])]), _vm._v(" "), _c('span', [_vm._v("Selected: " + _vm._s(_vm.selected))])]), _vm._v(" "), _c('ul', _vm._l(_vm.messages, function (message) {
        return _c('li', { key: message.key }, [_vm._v("\r\n            " + _vm._s(message.text) + "\r\n        ")]);
    }))]);
};
__vue__options__.staticRenderFns = [];
if (module.hot) {
...
;(function () {
    ...
    exports.default = {
        name: 'App',
        components: { Counter: _Counter2.default, Navbar: _Navbar2.default, Message: _Message2.default }
    };
})();
if (module.exports.__esModule) module.exports = module.exports.default;
var __vue__options__ = typeof module.exports === "function" ? module.exports.options : module.exports;
...
},{"./Counter.vue":"src\\Counter.vue","./Navbar.vue":"src\\Navbar.vue","./Message.vue":"src\\Message.vue","vue-hot-reload-api":"node_modules\\vue-hot-reload-api\\dist\\index.js","vue":"node_modules\\vue\\dist\\vue.runtime.esm.js"}],"app.js":[function(require,module,exports) {
'use strict';
